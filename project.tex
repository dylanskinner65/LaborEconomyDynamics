...
Thus, one improvement that can be made is finding a way to include present economic condit
Some of the weaknesses of our models (initial conditions cause different results in )
