...
We begin by building off the work of ~\cite{ElFadily}. In their work, ElFadily et. al. proposed a model
...
\begin{itemize}
    ...
    \item $\omega = 0.063$: The rate at which retired individuals re-enter the full-time workforce, denoted as $\omega$, was identified as 6.3\% or $0.063$ based on research by Maestas \cite{maestas}, resulting in $\omega = 0.192$.
\end{itemize}
